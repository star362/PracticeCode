...
public class DateTimeUtils {
    ...
    public static final DateTimeFormatter DATETIME_FORMATTWO = DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss");
    ...
    public static String getCurrentDateTimeTwo() {
        return LocalDateTime.now().format(DATETIME_FORMATTWO);
    }
